...
-   plats (.csv, .tsv, .txt) : <https://book.utilitr.org/03_Fiches_thematiques/Fiche_import_fichiers_plats.html>
...
## `R base` {.unnumbered .unlisted}
On peut utiliser les fonctions read.table, read.csv et read.csv2.
