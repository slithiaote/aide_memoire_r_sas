...
# En mois
donnees_tidyverse <- donnees_tidyverse %>% 
  mutate(age_mois = as.period(interval(start = date_naissance, end = date_entree))$month)

# En jours
donnees_tidyverse <- donnees_tidyverse %>% 
  mutate(age_jours = as.period(interval(start = date_naissance, end = date_entree))$day)
donnees_tidyverse <- donnees_tidyverse %>% 
