...
donnees_rbase$date_sortie <- donnees_datatable$date_entree + lubridate::days(donnees_rbase$duree)

# Date 6 mois après la sortie
donnees_rbase$date_6mois <- donnees_datatable$date_sortie %m+% months(6)
donnees_rbase$date_6mois <- lubridate::add_with_rollback(donnees_datatable$date_sortie, months(6))
donnees_rbase$date_6mois_2 <- donnees_datatable$date_sortie + lubridate::days(round(365.25/2))
```
