...
Ce document s'adresse aux utilisateurs de SAS qui veulent connaître la traduction du code SAS en R ainsi qu'aux utilisateurs de R qui ont besoin de comprendre le code SAS.

## Importation des packages

À FAIRE : on est d'accord qu'il faut adapter les importations selon les types d'environnement ?
...
À FAIRE : library(janitor) et library(tidyverse) suffisent non ? Puisque Tidyverse a déjà les autres packages ?
...
# On sélectionne les données de date
# FAIRE PLUS TARD ???



# Ne sélectionner que les variables numériques de la base
donnees_datatable[ , .SD, .SDcols = is.numeric]
...
### Passer une variable de numérique à caractère et vice-versa
