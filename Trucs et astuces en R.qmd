...
sort() trie un vecteur par ordre croissant.
rank() donne le rang de chaque élément du vecteur, le plus petit élément se voyant attribué le rang 1.
order() renvoie l'indice du vecteur trié par ordre croissant.
