...
# seq_len : créé une séquence d'éléments de 1 jusqu'au paramètre de la fonction
seq_len(10)
seq_len(-10)
...
# seq se comporte comme seq_along sauf si le vecteur ne comprend qu'un élement, et comme seq_len s'il en comprend plusieurs
