...
Le comportement du substr est différent entre `SAS` et `R` :

- en `SAS`, dans substr(extrait, 2, 3), le 2 correspond à la position du 1er caractère à récupérer, le 3 le nombre total de caractères à partir du 2e

- en `R`, dans substr("extrait", 2, 3), le 2 correspond à la position du 1er caractère à récupérer, le 3 à la position du dernier caractère
